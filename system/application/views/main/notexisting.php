...
<body>
	...
	<hr>
	<h2>
		На даный момент адрес свободен.<br /> 
		Если вы еще не пользуетесь нашим сайтом <a href="signup">Зарегистрируйтесь</a><br/>
		и присоединяйтесь к другим участникам проекта "Молодожены".
	</h2>
